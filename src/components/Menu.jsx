...
<nav id="nav">
    ...
    <Link to="/" style={{ textDecoration: 'none' ,color: 'inherit' }}> <h3 class="menuItem">ABOUT US</h3></Link>
    <Link to="/" style={{ textDecoration: 'none' ,color: 'inherit' }}> <h3 class="menuItem">CONTACT US</h3></Link>
